		...
		<div className="flex flex-col text-halfblack font-medium">
            <div className="flex flex-col pt-10">
                ...
                <div className="flex flex-col pt-7 w-96">
                    <label className="text-xs" htmlFor="phoneNumber">Телефон</label>
                    <input
                        value={phoneNumber}
                ...
                <div className="pt-4 flex flex-row">
                    ...
                    <label htmlFor="oferta" className="ml-[12px] block text-xs">Согласен (-на) с условиями оферты и с обработкой<br/> персональных данных</label>
                </div>
                { errors.length > 1 && <div className="pt-9 text-[#D92B26]">
                    { errors }
                </div>}
                <div className="pt-7">
                    <button
