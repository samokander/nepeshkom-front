...
export default function MainSlide({
  ...
  return (
    <div className="aspect-[3/2] relative">
      ...
      />
      <div
        className="cursor-pointer absolute flex rounded-full justify-center items-center bg-white w-8 h-8 top-1/2 left-2 select-none"
        onClick={leftClick}
      >
        <Image
      ...
      <div
        className="cursor-pointer absolute flex rounded-full justify-center items-center bg-white w-8 h-8 top-[50%] right-2 select-none"
        onClick={rightClick}
      >
        <Image
